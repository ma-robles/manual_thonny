...
6. Si no es posible hacer la carga automática (hay algún error), manten presionado el botón de *boot* en la tarjeta mientras presionas una vez el botón de reinicio en la ESP y a continuación click en *Instalar*. Una vez que comience la carga del firmware puedes soltar el botón *boot*.
